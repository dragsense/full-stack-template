...
import type {
  IEquipmentType,
  IEquipment,
} from "@shared/interfaces/equipment-reservation.interface";
...
export function useSearchableMembers({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useSearchableResources({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useSearchablePermissions({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useSearchableRoles({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useSearchableSubscriptions({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useSearchableAccessHours({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useSearchableAccessFeatures({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useSearchableLocations({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useSearchableEquipmentTypes({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useSearchableEquipment({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useSearchableDoors({
  locationId,
  initialParams,
}: {
  locationId?: string;
  ...
  // React 19: Memoized key generation for better performance
  const memoizedKey = useMemo(
    () => `searchable-doors-${locationId || "all"}`,
    [locationId],
  );
  ...
  const memoizedFetcher = useMemo(
    () => (params: IListQueryParams) => {
      ...
      return fetchDoors({
        ...withLocation,
        _select: "id, name, description, locationId,createdAt",
      });
    },
    [locationId],
  );
...
export function useSearchableBannerImages({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useSearchableServiceOffers({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useSearchableTrainerServices({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useSearchableProductTypes({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
...
export function useAttributeValues(
  attributeId: string,
  { initialParams }: { initialParams?: IListQueryParams },
) {
  const memoizedKey = useMemo(
  ...
  const memoizedFetcher = useMemo(
    () => (params: IListQueryParams) =>
      fetchAttributeValuesByAttribute(attributeId, params),
    [attributeId],
  );
...
export function useSearchableDeviceReaders({
  locationId,
  initialParams,
}: {
  locationId?: string;
...
export function useSearchableCameras({
  locationId,
  initialParams,
}: {
  locationId?: string;
  ...
  const memoizedFetcher = useMemo(
    () => (params: IListQueryParams) =>
      fetchCameras({ ...params, _select: "id, name, locationId" }, locationId),
    [locationId],
  );
...
export function useSearchableEmailTemplates({
  initialParams,
}: {
  initialParams?: IListQueryParams;
}) {
