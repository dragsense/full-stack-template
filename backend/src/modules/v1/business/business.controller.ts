...
export class BusinessController {
    ...
    @ApiOperation({ summary: 'Update current user\'s business (e.g. payment processor)' })
    @ApiBody({
        type: UpdateBusinessDto,
        description: 'Fields to update (e.g. paymentProcessorId)',
    })
    @ApiResponse({
        status: 200,
    ...
    async updateMyBusiness(
        ...
        return this.businessService.updateMyBusiness(currentUser, updateDto);
    }
